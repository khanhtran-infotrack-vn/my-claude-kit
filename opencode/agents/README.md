...
|-------|------|-------|--------------|
| **initializer** | Complete project bootstrap from conception to deployment | default | git-manager, researcher, planner, ui-ux-designer, tester, debugger, code-reviewer, docs-manager, project-manager |
