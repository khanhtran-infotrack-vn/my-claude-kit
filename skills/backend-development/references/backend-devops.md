...
### .NET Structured Logging (Serilog)
...
// Usage: _logger.LogInformation("Created product {ProductId}", product.Id);
```
...
public sealed class DataProcessingService : BackgroundService
{
